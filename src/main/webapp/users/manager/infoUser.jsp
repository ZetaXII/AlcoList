  ...
  <div class="content">
    <div class="row gx-4 containerTables px-3">
      ...
      <div class="col-3 mb-5">
        <button id="uuidEdit" value="" class="badge-user btn btn-view" onclick="redirectEditUser(value)">EDIT</button><button id="uuidDelete" value="" class="badge-user btn btn-view" onclick="deleteUser(value)">DELETE</button>
      </div>
