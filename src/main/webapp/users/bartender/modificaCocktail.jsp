                ...
                <div class="row g-0" style="background-color: var(--secondaryBlue); border-radius: 30px;">
                    ...
                    <div class="col-md-7">
                        <form class="card-body p-4 mt-4">
                            <h5 class="card-title"><input type="text" id="titleField" class="modifyCocktailFields form-control py-2 mb-4" placeholder="Titolo" maxlength="50" required></h5>

                            <input type="text" id="pathFileImgField" onfocusout="changeImg()" class="modifyCocktailFields form-control py-2 mb-4" placeholder="Link dell'immagine" maxlength="255" required>
                            ...
                            <p class="card-text cocktail-description"><input type="text" id="descriptionField" class="modifyCocktailFields form-control py-2 mb-4" placeholder="Descrizione" maxlength="50" required></p>
                            <p class="price"><input type="number" id="priceField" class="modifyCocktailFields form-control py-2 mb-4" placeholder="Prezzo (&euro;)" maxlength="50" required></p>
