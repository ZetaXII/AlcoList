            ...
            <div class="card info-item-panel mb-3 p-1" style="background-color: var(--secondaryBlue); border-radius: 30px;">
                <div class="row g-0" style="background-color: var(--secondaryBlue); border-radius: 30px;">
                    <div class="col-md-1 text-center">
                        <a id="backToListCocktail" onclick="backToListProduct()"><i class='bx bx-chevron-left back-button'></i></a>
                    ...
                    <div class="col-md-11">
                        <form class="card-body p-4 mt-4">
                            ...
                            <div class="text-center">
                                <button class="btn btn-modifyCocktail px-2 m-2 w-50 text-center" onclick="modifyProduct()">Modifica prodotto</button>
                            </div>
                    </div>
                </div>
            </div>
