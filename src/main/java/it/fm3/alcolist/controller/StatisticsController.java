...
public class StatisticsController {
	...
	public ResponseEntity<?> getBestSelling(@RequestParam Integer limit, HttpServletRequest request) throws Exception {
		return ResponseEntity.ok(statisticsService.getBestSellingCocktails(limit));
	}
	
	@RequestMapping(value = "/getBestSellingCocktailsByFlavour", method = RequestMethod.POST)
	public ResponseEntity<?> getBestSellingByFlavour(HttpServletRequest request) throws Exception {
		return ResponseEntity.ok(statisticsService.getBestSellingCocktailsByFlavour());
	}
