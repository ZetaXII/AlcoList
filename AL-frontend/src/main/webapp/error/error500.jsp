        ...
        <div class="col-xl-5 col-md-8 p-6" style="width:90%; margin-top:10%;">
            <div class="card b-2 form-login">
                <div class="card-body p-5" style="height: 300px;">
                    <h1 class="h1 text-center card-title mb-4 mt-5"><b>ERROR 500!</b></h1>
                    <h3 class="h3 text-center card-title">Errore interno del server <a href="${pageContext.request.contextPath}/index.jsp">torna all'inizio</a></h3>
                </div>
            </div>
        </div>
    </div>
